...
# Network information
network --device=ens192 --onboot=yes --noipv6 --bootproto=static --ip=192.168.21.121 --netmask=255.255.255.0 --gateway=192.168.21.1 --nameserver=192.168.20.69
network --hostname=adm01.gpssus.com
